...
describe('Visualization API', () => {
  ...
  describe('GET /api/visualization/results/:id/visualization', () => {
    it('should get visualization data for assessment results', async () => {
      ...
      const response = await request(app)
        .get('/api/visualization/results/1/visualization')
        .expect(200);

      expect(response.body).toHaveProperty('categoryScores');
      expect(response.body).toHaveProperty('progressOverTime');
    ...
    it('should return 404 if assessment not found', async () => {
      ...
      await request(app)
        .get('/api/visualization/results/999/visualization')
        .expect(404);
    });
